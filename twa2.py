...
while True:
    ...
    try:
        ...
        # チャット欄
        pyautogui.click(x=386, y=745, interval=0.5, button="left")
        pyautogui.hotkey("ctrl", "v")
        pyautogui.hotkey("enter")
        time.sleep(5)

        # エアフレンドの発言
        pyautogui.click(x=455, y=670, interval=0.5, button="right")

        # コピー
        pyautogui.click(x=497, y=691, interval=0.5, button="left")
        time.sleep(1)
